...
namespace dBridges.channel  
{
    public class channel : Action_dispatcher
    {
       ...
       public string getChannelName()
        ...
        public async Task publish(string eventName, string eventData,  string seqnum)
        {
            if (!this._isOnline) { throw (new dBError("E014")); }
            ...
            bool m_status = await util.updatedBNewtworkSC(this.dbcore, MessageType.PUBLISH_TO_CHANNEL, this.channelName,  null, eventData, eventName, null, 0, seqnum);
        ...
        public async Task sendmsg( string eventName, string eventData, string to_session_id, string source_id = null, string seqnum = null)
        {
            ...
            if (!this._isOnline) { throw (new dBError("E033")); }
            ...
            if (!m_status) throw (new dBError("E033"));
            return;
        }
